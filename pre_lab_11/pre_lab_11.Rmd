...
**Answer** A dataframe with four columns and 999 rows that show the date, title, url and text of the press release.
...
**Answer** It takes the repeats of certain words and consolidates them so it only gives a row of the unique ones
...
**Answer** A column of words, all lowercase but there are still periods
...
**Answer** It's kind of funny that Maryland only just barely makes the top 25 list and the rest of the words are mostly articles and prepositions outside of U.S. All the words are also lowercased. But no, it's not very interesting.
...
**Answer** I think so -- it shows the percent of times the word is mentioned and focuses on more interesting words, using the anti-join between the two dataframes to bring these to the top ahead of the boring words.
...
**Answer** Health slowly moves down the list from 2021 to 2023. Covid-19 completely fell off the list after 2021 and womens rights came up in 2023.
...
**Task** Run the following code and describe the results.
**Answer** We get a dataframe of words that carry more weight together than in the first one, plus the percentage and number of times that they're mentioned. COVID-19, human rights and 19 pandemic are the top three phrases. Rescue plan makes the list too if we combine "19 pandemic" with "COVID 19"
...
**Task** Run the following code and describe the results.
**Answer** Project location, amount included and health care are all in the top three now. Health still remains among the top results.
...
**Task** Run the following code and describe the results.
**Answer** Health care remains in the top results as third, but human rights and equal rights have jumped to the top
...
**Answer** This is really cool. "Critical" as a negative word could be either way since sometimes criticism is used to improve rather than just tear down. As for what I see, it shows three different datasets for the three years. Some of the words are similar and have similar connotations.
