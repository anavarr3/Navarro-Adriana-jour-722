...
**A1** Engineering, Cooperative Education -- It surprises me that on the very last slide, Music Performance and then the National Institute of Aeronautics - NC have about 1 seat on average.
...
**Q4** Given the results for Q3, what would have made it easier to find the answer? You don't have to know *how* to accomplish this; I want you to describe in words what would make the answer easier to see. How confident are you that the answer you got is the right one, and why? **A4** Filtering out the N/A and TBA answers. I'm confident now, but probably would have gotten it wrong if I wasn't also searching the department

**Q5** Take one of the questions you listed in the final question of the pre_lab and try to answer it here in code. If you don't know how to fully answer it, write what code you can and describe in words what else you would need to do. If you got an answer, is it interesting? **A5**  Which department has the lowest number of classes? Five different classes: Academic Achievement Programs, Anti-Black Racism, MS Business & Management Track, Museum Scholarship and Material Culture and Undergraduate Studies.
