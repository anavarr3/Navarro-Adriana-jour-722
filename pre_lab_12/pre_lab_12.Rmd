...
**Answer** It looks just like the dataframes I'm used to seeing. Now, however, the columns match the ones on the website.
...
**Answer** I'd like to add the author, the number of pageviews if possible.
...
**Answer** It looks like all li tags, so at least one ul tag present if there are typically multiple li tags inside of ul tags
...
**Answer** It basically looks like the full page laid out into a list.
...
**Answer** Releases showed up in our environment as a dataframe, though it only has one column.
